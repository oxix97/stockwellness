package org.stockwellness.batch.job.stockmaster.step.tasklet;
...
public class StockDelistTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        int count = stockMasterSyncUseCase.markDelisted(
                new StockMasterSyncUseCase.StockDelistCommand(marketType, activeTickers)
        ).delistedCount();
