...
ALTER TABLE stock_price ADD COLUMN IF NOT EXISTS net_institutional_buying_amt DECIMAL(25, 2) DEFAULT 0;
ALTER TABLE stock_price ADD COLUMN IF NOT EXISTS net_foreign_buying_amt DECIMAL(25, 2) DEFAULT 0;
