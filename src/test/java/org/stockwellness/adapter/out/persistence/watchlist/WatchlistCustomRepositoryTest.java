...
class WatchlistCustomRepositoryTest {
    ...
    void findGroupsWithItemCount() {
        ...
        Stock stock1 = Stock.create("S1", "N1", "T1", MarketType.KOSPI, 1L, "C1", "CN1");
        Stock stock2 = Stock.create("S2", "N2", "T2", MarketType.KOSPI, 1L, "C2", "CN2");
    ...
    void findItemsWithStock() {
        ...
        Stock stock = Stock.create("S1", "삼성전자", "005930", MarketType.KOSPI, 1L, "C1", "CN1");
