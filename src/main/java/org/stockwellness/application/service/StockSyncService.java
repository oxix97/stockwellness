...
import org.stockwellness.domain.stock.StockHistoryJdbcRepository;
...
public class StockSyncService {
    ...
    public void syncStockMasterData(String baseDate) {
        ...
        items.forEach(it -> {
            stockRepository.findByTicker(it.ticker())
                    .ifPresentOrElse(
                            ...
                            () -> stockRepository.save(stockMapper.toStockEntity(it))
                    );
        });
    }
