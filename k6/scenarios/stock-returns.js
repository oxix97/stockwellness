...
export const options = (__ENV.K6_MODE === "quick" ? quickOptions : readOptions)('stock_returns');

export default function () {
  const res = http.get(`${BASE_URL}/api/v1/stocks/${TICKER}/returns?period=${PERIOD}`, {
    tags: { api: 'stock_returns', type: 'read' },
  });

  assertApiSuccess('stock returns', res);
  sleep(1);
}
